 ...
 *                       Handler should be light-weight and never block!
 */
final class PushSpout[+A] private (val initialBufferSize: Int, val maxBufferSize: Int, val growByInitialSize: Boolean,
...
object PushSpout {
   ...
   */
  def apply[T](initialBufferSize: Int, maxBufferSize: Int, growByInitialSize: Boolean = false,
